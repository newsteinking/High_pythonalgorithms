...
The Algorithms - Python :raw-html-m2r:`<!-- [![Build Status](https://travis-ci.org/TheAlgorithms/Python.svg)](https://travis-ci.org/TheAlgorithms/Python) -->`
==================================================================================================================================================================
...
.. image:: https://github.com/prateekiiest/Python/blob/master/sorts/sortinggraphs.png
   :target: https://github.com/prateekiiest/Python/blob/master/sorts/sortinggraphs.png
   :alt: Complexity Graphs


Comparing the sorting algorithms:
:raw-html-m2r:`<br>`  -Quicksort is a very fast algorithm but can be pretty tricky to implement
:raw-html-m2r:`<br>`  -Bubble sort is a slow algorithm but is very easy to implement. To sort small sets of data, bubble sort may be a better option since it can be implemented quickly, but for larger datasets, the speedup from quicksort might be worth the trouble implementing the algorithm.
...
.. image:: http://www.tutorialspoint.com/data_structures_algorithms/images/linear_search.gif
   :target: http://www.tutorialspoint.com/data_structures_algorithms/images/linear_search.gif
   :alt: alt text
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Linear_search>`_
######################################################################
...
.. image:: https://upload.wikimedia.org/wikipedia/commons/f/f7/Binary_search_into_array.png
   :target: https://upload.wikimedia.org/wikipedia/commons/f/f7/Binary_search_into_array.png
   :alt: alt text
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Binary_search_algorithm>`_
################################################################################
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Interpolation_search>`_
#############################################################################
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Jump_search>`_
####################################################################
...
.. image:: https://upload.wikimedia.org/wikipedia/commons/0/04/Selecting_quickselect_frames.gif
   :target: https://upload.wikimedia.org/wikipedia/commons/0/04/Selecting_quickselect_frames.gif
   :alt: alt text
...
Quickselect uses the same overall approach as quicksort, choosing one element as a pivot and partitioning the data in two based on the pivot, accordingly as less than or greater than the pivot. However, instead of recursing into both sides, as in quicksort, quickselect only recurses into one side – the side with the element it is searching for. This reduces the average complexity from O(n log n) to O(n), with a worst case of O(n\ :raw-html-m2r:`<sup>2</sup>`\ ).
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Tabu_search>`_
####################################################################
...
**Caesar cipher**\ , also known as *Caesar's cipher*\ , the *shift cipher*\ , *Caesar's code* or *Caesar shift*\ , is one of the simplest and most widely known encryption techniques.\ :raw-html-m2r:`<br>`
It is **a type of substitution cipher** in which each letter in the plaintext is replaced by a letter some fixed number of positions down the alphabet. For example, with a left shift of 3, D would be replaced by A, E would become B, and so on. :raw-html-m2r:`<br>`
The method is named after **Julius Caesar**\ , who used it in his private correspondence.\ :raw-html-m2r:`<br>`
The encryption step performed by a Caesar cipher is often incorporated as part of more complex schemes, such as the Vigenère cipher, and still has modern application in the ROT13 system. As with all single-alphabet substitution ciphers, the Caesar cipher is easily broken and in modern practice offers essentially no communication security.

Source: `Wikipedia <https://en.wikipedia.org/wiki/Caesar_cipher>`_
######################################################################
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Vigen%C3%A8re_cipher>`_
#############################################################################
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/Transposition_cipher>`_
#############################################################################
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/RSA_(cryptosystem>`_\ )
###########################################################################
...
.. image:: https://upload.wikimedia.org/wikipedia/commons/3/33/ROT13_table_with_example.svg
   :target: https://upload.wikimedia.org/wikipedia/commons/3/33/ROT13_table_with_example.svg
   :alt: alt text
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/ROT13>`_
##############################################################
...
Source: `Wikipedia <https://en.wikipedia.org/wiki/XOR_cipher>`_
###################################################################
